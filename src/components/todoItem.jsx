...
export default function TodoItem(props) {
    const [showTick, setShowTick] = useState(props.completed);
    ...
    return (
        <div id={props.id} className="todo-item">
            <div className="todo-left">
                <div className="todo-action" onClick={() => props.toggle(props.id)} onMouseEnter={() => setShowTick(!showTick)} onMouseLeave={() => setShowTick(!showTick)}>
